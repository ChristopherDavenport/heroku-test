...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/ChristopherDavenport/heroku-test"),
        "git@github.com:ChristopherDavenport/heroku-test.git"
      )
    ),
    homepage := Some(url("https://github.com/ChristopherDavenport/heroku-test")),
